...
[RegisterCharacter]
public sealed class
    AkiSisterCharacter : ModCharacterTemplate<AkiSisterCardPool, AkiSisterRelicPool, AkiSisterPotionPool>
{
    public static readonly Color ThemeColor = new("F5DEB3");
    ...
    private const string CharacterScenePath = $"{SceneRoot}/AkiSister_character.tscn";
    private const string EnergyCounterScenePath = $"{SceneRoot}/AkiSister_energy_counter.tscn";
    private const string MerchantScenePath = $"{SceneRoot}/AkiSister_merchant.tscn";
    private const string RestSiteScenePath = $"{SceneRoot}/AkiSister_rest_site.tscn";
    private const string CharacterSelectBgScenePath = $"{SceneRoot}/AkiSister_character_select_bg.tscn";
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        Ui: new CharacterUiAssetSet(
            ...
            // 人物选择图标。
            CharacterSelectIconPath: $"{ImageRoot}/AkiSister_character_select.png",
            // 人物选择图标-锁定状态。
    ...
    //    typeof(AkiSizuhaGrasses),
    //    typeof(AkiMinorikoGrasses),
    //];
